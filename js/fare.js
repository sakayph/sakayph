...
var calculateFare = function() {
  var busFares = {
    ...
    puj: [
      { regular: 0, discounted: 0 },
      { regular: 7.50, discounted: 6.00 },
      { regular: 7.50, discounted: 6.00 },
      { regular: 7.50, discounted: 6.00 },
      { regular: 7.50, discounted: 6.00 },
      { regular: 9.00, discounted: 7.25 },
      { regular: 10.50, discounted: 8.50 },
      { regular: 12.00, discounted: 9.50 },
      { regular: 13.50, discounted: 10.75 },
      { regular: 15.00, discounted: 12.00 },
      { regular: 16.50, discounted: 13.25 },
      { regular: 18.00, discounted: 14.50 },
      { regular: 19.50, discounted: 15.50 },
      { regular: 21.00, discounted: 16.75 },
      { regular: 22.50, discounted: 18.00 },
      { regular: 24.00, discounted: 19.25 },
      { regular: 25.50, discounted: 20.50 },
      { regular: 27.00, discounted: 21.50 },
      { regular: 28.50, discounted: 22.75 },
      { regular: 30.00, discounted: 24.00 },
      { regular: 31.50, discounted: 25.25 },
      { regular: 33.00, discounted: 26.50 },
      { regular: 34.50, discounted: 27.50 },
      { regular: 36.00, discounted: 28.75 },
      { regular: 37.50, discounted: 30.00 },
      { regular: 39.00, discounted: 31.25 },
      { regular: 40.50, discounted: 32.50 },
      { regular: 42.00, discounted: 33.50 },
      { regular: 43.50, discounted: 34.75 },
      { regular: 45.00, discounted: 36.00 },
      { regular: 46.50, discounted: 37.25 },
      { regular: 48.00, discounted: 38.50 },
      { regular: 49.50, discounted: 39.50 },
      { regular: 51.00, discounted: 40.75 },
      { regular: 52.50, discounted: 42.00 },
      { regular: 54.00, discounted: 43.25 },
      { regular: 55.50, discounted: 44.50 },
      { regular: 57.00, discounted: 45.50 },
      { regular: 58.50, discounted: 46.75 },
      { regular: 60.00, discounted: 48.00 },
      { regular: 61.50, discounted: 49.25 },
      { regular: 63.00, discounted: 50.50 },
      { regular: 64.50, discounted: 51.50 },
      { regular: 66.00, discounted: 52.75 },
      { regular: 67.50, discounted: 54.00 },
      { regular: 69.00, discounted: 55.25 },
      { regular: 70.50, discounted: 56.50 },
      { regular: 72.00, discounted: 57.50 },
      { regular: 73.50, discounted: 58.75 },
      { regular: 75.00, discounted: 60.00 },
      { regular: 76.50, discounted: 61.25 },
    ]
  };
  ...
  var railFares = {
    'ROUTE_880747': { // LRT1
      fares: [
        ...
        [ 30,30,30,30,30,30,30,30,20,20,20,20,20,20,15,15,15,15,0,15 ],
      ...
      getFare: function(from, to) {
        ...
        return this.fares[fromIndex][toIndex];
      }
    },

    "ROUTE_880801": { // LRT2
      fares: [
        [ 0,15,15,15,20,20,20,20,25,25,25 ],
        [ 15,0,15,15,15,20,20,20,20,25,25 ],
        [ 15,15,0,15,15,15,20,20,20,20,25 ],
        [ 15,15,15,0,15,15,15,20,20,20,25 ],
        [ 20,15,15,15,0,15,15,15,20,20,20 ],
        [ 20,20,15,15,15,0,15,15,15,20,20 ],
        [ 20,20,20,15,15,15,0,15,15,15,20 ],
        [ 20,20,20,20,15,15,15,0,15,15,15 ],
        [ 25,20,20,20,20,15,15,15,0,15,15 ],
        [ 25,25,20,20,20,20,15,15,15,0,15 ],
        [ 25,25,25,25,20,20,20,15,15,15,0 ],
      ],
      stations: [
